...
{
	partial class SelectPaymentSampleForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// lvPaymentSamples
			// 
			lvPaymentSamples.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Right;
			lvPaymentSamples.Location = new Point(331, 116);
			lvPaymentSamples.Name = "lvPaymentSamples";
			lvPaymentSamples.Size = new Size(569, 552);
		...
		private ListView lvPaymentSamples;
